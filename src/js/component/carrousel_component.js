...
const Carrousel_component = (props) => {
    ...
    return(
        <>            
            <div className="col-md-6 col-lg-4 col-xs-12 me-5"> 
                <div className="card mx-auto">
                    ...
                    <div className="card-body">
                        ...
                        <Link to={`/detail/${type}/${whole_thing.uid}`}>
                            <button className="btn btn-primary btn-lg" type="submit" > <p className="btn_text mx-auto my-auto">Learn more!</p> </button>
                        </Link>
